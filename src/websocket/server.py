...
from src.websocket import utils
from collections import namedtuple
from src.websocket.model_db import ModelService 
import requests
import configparser
...
class ServeClientBase(object):
    ...
    def __init__(self, client_uid, websocket):
        ...
        self.http_url = 'http://127.0.0.1:8000/transcribe_websocket'
        self.user_type = None
        self.file_name = None
...
class ServeClientFasterWhisper(ServeClientBase):
    ...
    def handle_transcription_output(self, result, duration, is_end=False):
        ...
        if len(segments) or is_end:
            ...
            if (not is_end) and (_cur == _prev):
                print('handle_transcription_output not sending (duplicate)')
                return segments
            setattr(self, "_prev_segments_json", _cur)
